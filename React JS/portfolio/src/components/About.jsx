  ...
  return (
    <div className="about py-5 md:py-12 lg:py-14 px-5 sm:px-10 md:px-15 lg:px-20 flex flex-col md:flex-row justify-between items-start gap-8">
      ...
      <div className="text-content sm:w-full md:w-1/2">
        <h1 className="mb-2 text-slate-300 text-[1.1rem] md:text-[1.2rem] font-bold tracking-wider ">
        ...
        <p className="text-slate-300 text-[1.2rem] mt-2">
          ...
          such as React.js. I specialize in crafting layouts, styling
        ...
        <a
          ...
          className="bg-slate-300 w-full md:w-[60%] lg:w-[50%] xl:w-[35%] flex justify-center items-center mt-6 py-3 text-[1.05rem] rounded-lg"
        >
          <FontAwesomeIcon icon={faDownload} className="mr-2 text-slate-500" />
          Download Resume
        </a>
      </div>
    </div>
